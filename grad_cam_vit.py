...
if __name__ == '__main__':
    ...
    model = SLRModel(1296, "vitb_mstcn-3", 2)
    cnn_sd = torch.load("/data/ahmed026/phoenix/ViTB_TAPE_MSTCN_a1/_best_model.pt", map_location=torch.device('cpu'))["model_state_dict"]
    ...
    target_layers = [model.conv2d.encoder.ln]
    ...
    for i in tqdm(range(T)):
        ...
        overlay = cv2.addWeighted(rgb_image, 0.5, colored_cam, 0.5, 0)

        cv2.imwrite(f'./gradcams/vit/{i}.jpg', overlay)